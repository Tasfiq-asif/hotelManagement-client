  ...
  return (
    <div className="p-8">
      ...
      <form
        ...
        className="flex flex-col items-center gap-4 mb-8 md:flex-row md:justify-center"
      >
        <input
          type="number"
      ...
      <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
        {rooms.map((room, index) => (
          <div
            key={index}
            className="card bg-background shadow-xl transform transition duration-300 hover:scale-105 "
          >
            <figure>
              <img
            ...
            <div className="card-body">
              ...
              <p
                className={`font-medium ${
                  room.availability ? "text-green-500" : "text-red-500"
                }`}
              >
